...
//    }
    ...
    public Customer update(int cid, Vehicle objCustomer) {
       Optional<Customer> v1 = custRepo.findById(cid);
        if(!v1.isPresent ())
        {
            throw new CustomerNotFoundException ("Customer with id :" + cid +" not found");
    ...
    public void Delete(int cid) {
        Optional<Customer> v1 = cistRepo.findById(cid);
        if(!v1.isPresent ())
        {
            throw new CustomerNotFoundException ("Cistomer with id :" + cid +" not found");
        }
